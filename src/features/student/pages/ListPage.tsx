            ...
            {loading ? (<LinearProgress color="secondary" />
                ...
                <CardContent sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <Button variant="contained">
                        <NavLink style={{ textDecoration: "none", color: "white" }} to={`${location.pathname}/add`}>ADD NEW STUDENT</NavLink>
                    </Button>
                </CardContent>
                <Divider />
                <CardContent>
                    <StudentFilter filter={filter} onChange={onChangeFilter} onSearchChange={onSearchChangeFilter} cityList={cityList} />
                </CardContent>
                <Divider />
                <CardContent>
                    <StudentTable students={students} citiesMap={citiMap} onEdit={handleStudentEdit} onRemove={handleStudentRemove} />
                </CardContent>
