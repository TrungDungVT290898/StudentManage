...
export const selectDashboardLoading = (state: RootState) => state.dashboard.loading as boolean;
...
export const selectRankingByCity = (state: RootState) => state.dashboard.rankingByCityList as IRankingByCity[];
//Reducer
