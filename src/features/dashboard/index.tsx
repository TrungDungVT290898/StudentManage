                ...
                <div>
                    <Stack >
                        <Grid sx={gridContainer} container>
                            ...
                            <Grid sx={gridStyle}>
                                <StatisticItem key="highcount" icon={<StarBorderIcon />} label={"High Mark"} value={statistics.highMarkCount} />
                            </Grid>
                            <Grid sx={gridStyle}>
                                <StatisticItem key="lowcount" icon={<ThumbDownOffAltIcon />} label={"Low Mark"} value={statistics.lowMarkCount} />
                            </Grid>
                    ...
                    <Stack mt={4}>
                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            ...
                            <Grid key="highlist" item xs={2} sm={4} md={4} >
                                <Widget bgColor='green' title="Student with highest mark"><StudentRankingList students={highestStudentList} /></Widget>
                            </Grid>
                            <Grid key="lowlist" item xs={2} sm={4} md={4} >
                                <Widget bgColor='tomato' title="Student with lowest mark"><StudentRankingList students={lowestStudentList} /></Widget>
                            </Grid>
                        ...
                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                            ...
                            {rankingByCityList.map(city => (
                                <Grid key={`city_${city.cityId}_code_grid`} item xs={2} sm={3} md={3} >
                                    <Widget bgColor='#3B3A3F' title={city.cityName}><StudentRankingList students={city.rankingList} /></Widget>
                                </Grid>
                            ))}
